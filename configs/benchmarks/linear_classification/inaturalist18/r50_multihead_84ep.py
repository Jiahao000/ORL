...
data_train_list = 'data/inaturalist18/meta/train_labeled.txt'
data_train_root = 'data/inaturalist18'
data_test_list = 'data/inaturalist18/meta/val_labeled.txt'
data_test_root = 'data/inaturalist18'
